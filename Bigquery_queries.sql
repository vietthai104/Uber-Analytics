CREATE OR REPLACE TABLE `data-analytics-NguyenVietThai.tbl_analytics` AS (
SELECT 
    f.trip_id,
    f.VendorID,
...
FROM 
    `data-analytics-NguyenVietThai.tbl_analytics`
GROUP BY 
    VendorID
ORDER BY 
    total_revenue DESC

--Top 5 pick up locations by frequency
SELECT 
    pickup_latitude, 
    pickup_longitude, 
...
--Average tip amount by trip distance
SELECT 
    trip_distance, 
